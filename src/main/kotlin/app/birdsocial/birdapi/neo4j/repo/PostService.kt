...
class PostService(
...
) : Neo4jService<PostNode>(
    neo4j,
    sentry,
) {
    val label = "Post"

    override fun findOneById(id: String): PostNode {
    ...
    override fun findOneByParam(paramName: String, param: String): PostNode {
    ...
    override fun findAllByParam(paramName: String, param: String, page: Int, pageSize: Int): List<PostNode> {
